...
const caData = [
  { mois: "Oct", ca: 9200000 }, { mois: "Nov", ca: 10500000 }, { mois: "Déc", ca: 11800000 },
  { mois: "Jan", ca: 10200000 }, { mois: "Fév", ca: 11400000 }, { mois: "Mar", ca: 12450000 },
];
const commandesData = [
...
export default function AdminDashboard() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-heading font-bold">Tableau de bord — Direction Générale</h1>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <CardContent className="pt-6">
            <p className="text-sm font-heading font-semibold mb-4">Évolution du CA (6 mois)</p>
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-sm font-heading font-semibold mb-4">Répartition des dépenses</p>
            <ResponsiveContainer width="100%" height={250}>
              <PieChart>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-sm font-heading font-semibold mb-4">Alertes</p>
